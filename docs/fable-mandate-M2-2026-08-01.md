...
## M2-3 · Bottom-up rankings — the first of the three, and the one he most wants moved
...
order, with what it would cost. Four named feature blocks sit in the database untouched (snap counts
2013+, NGS 2016+, PBP red-zone and xFP, recency weighting). A defect the founder found by eye means
the availability sub-model mis-ranks every player who missed time, in **both** directions — Burrow
(8 games in 2025) at QB26 against consensus QB4-ish; Taysom Hill up 194 places.
...
update** — the file is worthless to him unpushed.
