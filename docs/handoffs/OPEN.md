...
**Generated 2026-07-27 by `tools/handoffs.py sync` — do not hand-edit.**
...
| ID | Subject | From | Status | Age | Blocks |
|---|---|---|---|---|---|
| [001](001-adopt-current-state.md) | Adopt current state | `pm` | OPEN | 1d | none |
| [002](002-per-pick-draft-state.md) | Per pick draft state | `pm` | OPEN | 1d | 007 (mock collection, not yet opened) |
| [012](012-sprint-1-runbook.md) | Sprint 1 runbook | `pm` | OPEN | 1d | none |
| [021](021-per-position-rank-correlation.md) | Per position rank correlation | `pm` | OPEN | 1d | D-002, D-003 |
| [022](022-test-suite-speedup.md) | Test suite speedup | `pm` | OPEN | 1d | none |
| [026](026-recompute-progress-streaming.md) | Recompute progress streaming | `pm` | OPEN | 1d | Settings editor build |
| [032](032-assistant-dev-mode.md) | Assistant dev mode | `pm` | OPEN | 1d | none |
| [033](033-assistant-query-architecture.md) | Assistant query architecture | `pm` | OPEN | 1d | the assistant rebuild sprint |
| [036](036-mocklab-staleness-retrofit.md) | Mocklab staleness retrofit | `pm` | OPEN | 1d | Mock Lab build |
| [037](037-audit-followups.md) | Audit followups | `pm` | OPEN | 1d | none |
| [040](040-multi-league-slot-and-undo.md) | Multi league slot and undo | `pm` | OPEN | 0d | Mock Lab build, Settings build |
| [042](042-strategies-json-stale-at-contract-1-7-0.md) | Strategies json stale at contract 1 7 0 | `frontend` | OPEN | 1d | none |
| [045](045-simulation-lookahead.md) | Simulation lookahead | `pm` | OPEN | 0d | 044 (the roster-aware recommendation should use this once it exists) |
| [047](047-manual-draft-setup-entry.md) | Manual draft setup entry | `pm` | OPEN | 0d | usable mock drafting |
| [050](050-sprint-3-runbook.md) | Sprint 3 runbook | `pm` | OPEN | 0d | none |
...
| [069](069-global-tier-field-for-all-tab-board-grouping.md) | Global tier field for all tab board grouping | `frontend` | OPEN | 0d | 058 section B1 (design fidelity) |
| [070](070-sim-staleness-fields-for-league-identity-current.md) | Sim staleness fields for league identity current | `frontend` | OPEN | 0d | 058 section C3 (design fidelity) |

### `frontend` — 16 waiting

| ID | Subject | From | Status | Age | Blocks |
|---|---|---|---|---|---|
| [003](003-frontend-reconnect.md) | Frontend reconnect | `pm` | OPEN | 1d | none |
| [006](006-design-sync-pilot.md) | Design sync pilot | `pm` | OPEN | 1d | none |
| [007](007-design-fidelity-harness.md) | Design fidelity harness | `pm` | OPEN | 1d | none |
| [011](011-locate-frontend-spec.md) | Locate frontend spec | `pm` | OPEN | 1d | 007 |
| [029](029-frequency-array-on-board.md) | Frequency array on board | `pm` | OPEN | 1d | none |
| [030](030-inline-why-rank-differs.md) | Inline why rank differs | `pm` | OPEN | 1d | none |
| [031](031-frontend-spec-audit-and-wiring.md) | Frontend spec audit and wiring | `pm` | OPEN | 1d | 027, 028, Settings build |
| [035](035-frontend-catchup-runbook.md) | Frontend catchup runbook | `pm` | OPEN | 1d | 003, 027, 028, 029, 030, 031, and every future frontend thread |
| [036](036-mocklab-staleness-retrofit.md) | Mocklab staleness retrofit | `pm` | OPEN | 1d | Mock Lab build |
| [037](037-audit-followups.md) | Audit followups | `pm` | OPEN | 1d | none |
| [040](040-multi-league-slot-and-undo.md) | Multi league slot and undo | `pm` | OPEN | 0d | Mock Lab build, Settings build |
...
| ID | Subject | From | Status | Age | Blocks |
|---|---|---|---|---|---|
| [046](046-bottom-up-ranking-data.md) | Bottom up ranking data | `pm` | OPEN | 0d | bottom-up ranking framework |
...
| ID | Subject | From | Status | Age | Blocks |
|---|---|---|---|---|---|
| [062](062-backlog-reconciliation.md) | Backlog reconciliation | `pm` | OPEN | 0d | none |
