...
**This is a point-in-time capture, not a rival to `docs/CURRENT-STATE.md`. It will drift the moment
the source does. For current state, read `docs/CURRENT-STATE.md`, never this file.**
